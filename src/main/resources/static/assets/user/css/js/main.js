...
/*----------------------------------------*/
 ...
 $('.product-details-images1').each(function(){
     var $this = $(this);
     var $thumb = $this.siblings('.product-details-thumbs1, .tab-style-left');
     $this.slick({
        arrows: false,
        slidesToShow: 1,
        slidesToScroll: 1,
 ...
 $('.product-details-thumbs1').each(function(){
     var $this = $(this);
     var $details = $this.siblings('.product-details-images1');
     $this.slick({
        slidesToShow: 3,
        slidesToScroll: 1,
        autoplay: false,
...
/*----------------------------------------*/
 ...
 $(".qtybutton").on("click", function() {
    ...
    $input.val(newVal);
	var colorId = $input.closest("tr").find(".li-product-color .color").data("color-id");
	$.ajax({
	  url: "/cart/update",
	  method: "POST",
	  data: { colorId: colorId, quantity: newVal },
	  dataType: "json",
	  success: function (response) {
		...
		//   var subtotal;
		//   if (response.giamGiaTrucTiep != null) {
		// 	subtotal = (price - ((sale / 100) * giaBan));
		//   }
		//   else{
		...
		//   $input.closest("tr").find(".product-subtotal .amount").text(formatCurrency(subtotal));
